    ...
    getWholeTripsForUser(db, user_id) {
        return db
            ...
            .select(
                ...
                'days.id AS days:days_id',
                'days.trip_id AS days:trip_id',
                'activities.id AS days:activities:id',
                'activities.activity AS days:activities:activity',
                'activities.meridiem AS days:activities:meridiem',
                'activities.start_time AS days:activities:start_time',
                'activities.day_id AS days:activities:day_id'
            )
