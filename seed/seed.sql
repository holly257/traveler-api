...
INSERT INTO  reviews (name, image, image_alt, city, country, address, rating, category, comments, user_id)
    VALUES
        ...
        ('Bran Castle', 'https://www.twoscotsabroad.com/wp-content/uploads/2019/07/Bran-Castle-Romania-with-blue-skies.jpg', 'castle in Romania with trees', 'Bran', 'Romania', 'Strada General Traian Moșoiu 24, Bran 507025, Romania', 2, 'activity', `It's okay as long as you know what you are getting into. It's definitely a tourist trap. There's beautiful hiking nearby.`, 3),
        ...
        ('Penguin Colony', 'https://images.unsplash.com/photo-1530273745941-4bb6a3669e93?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80', 'penguins on the beach', 'Cape Town', 'South Africa', `4 Boulders Place, Secluse Ave, Simon's Town, Cape Town, 7995, South Africa`, 4, 'activity', 'Beautiful place to see penguins and the beach - but a very long, curvy drive from downtown.', 1),
        ...
        ('The Vortex', 'https://www.ajc.com/rf/image_inline/Pub/p6/AJC/2015/08/12/Images/photos.medleyphoto.7901658.JPG', 'the vortex burgers', 'Atlanta', 'USA', '438 Moreland Ave NE, Atlanta, GA 30307', 5, 'restaurant', 'Beat burgers in town! Famous for being unhealthy and not kid friendly', 2),
